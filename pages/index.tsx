  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col min-h-screen pt-20 px-10 2xl:px-0 lg:py-0 overflow-hidden">
      ...
      <div className='grid grid-rows-2 justify-between h-screen lg:grid-cols-2 md:grid-cols-2 box-border'>
        <div className="col-span-2 md:col-span-1 lg:col-span-1 lg:row-span-2 mb-12 mt-24 sm:mt-16 flex flex-col space-y-6 text-center md:mb-0 md:text-left md:justify-center md:space-y-1 lg:justify-center lg:space-y-2">
